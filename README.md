...
Live app: playlist-analyzer.streamlit.app
...
Go to playlist-analyzer.streamlit.app, export a playlist from exportify.net, and upload it.
Option 2 — Run locally
bashgit clone https://github.com/npockriss/spotify-analyzer
cd spotify-analyzer
pip install -r requirements.txt
streamlit run spotify_app.py

Exporting your playlist
This app uses CSVs exported from exportify.net, which includes audio features (energy, valence, danceability, etc.) for every track. Native Spotify exports also work.

Go to exportify.net and log in with Spotify
Find your playlist and click Export
Upload the downloaded CSV to the app
...
Add https://playlist-analyzer.streamlit.app/ as a Redirect URI
Copy your Client ID and Client Secret into the app sidebar
